...
class OperateFakePlayerGUI extends SimpleInventoryHandler {
    ...
    public void placeButtons(Player p, Inventory inv) {
        ...
        ItemStack info = new ItemStackBuilder(Material.PLAYER_HEAD, 1)
    ...
    public Component title(Player p) {
        return fpm.getMessageHandler().getColored(p, "GUI.EachPlayerTitle", new ObjectArray(Implementations.getName(data)));
    }
